...
package net.mcreator.prova.world.biome;
...
import net.mcreator.prova.block.AceroLogBlock;
import net.mcreator.prova.block.AceroLeavesBlock;
...
public class AceriBiome extends ProvaModElements.ModElement {
	...
	public AceriBiome(ProvaModElements instance) {
		super(instance, 60);
	}
								...
								for (Direction Direction : Direction.Plane.HORIZONTAL) {
									if (rand.nextInt(4 - hlevel) == 0) {
										...
										setTreeBlockState(changedBlocks, world, position.add(dir.getXOffset(), height - 5 + hlevel, dir.getZOffset()),
												AceroLeavesBlock.block.getDefaultState(), bbox);
									}
								}
							}
						}
