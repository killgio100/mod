...
public class TopazioHoeItem extends ProvaModElements.ModElement {
	@ObjectHolder("prova:topazio_hoe")
	public static final Item block = null;
	public TopazioHoeItem(ProvaModElements instance) {
		super(instance, 30);
	}
