...
public class PlatinoAxeItem extends ProvaModElements.ModElement {
	@ObjectHolder("prova:platino_axe")
	public static final Item block = null;
	public PlatinoAxeItem(ProvaModElements instance) {
		super(instance, 89);
	}
