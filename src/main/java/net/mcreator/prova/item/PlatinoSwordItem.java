...
public class PlatinoSwordItem extends ProvaModElements.ModElement {
	@ObjectHolder("prova:platino_sword")
	public static final Item block = null;
	public PlatinoSwordItem(ProvaModElements instance) {
		super(instance, 90);
	}
