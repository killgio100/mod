...
public class PlatinoHoeItem extends ProvaModElements.ModElement {
	@ObjectHolder("prova:platino_hoe")
	public static final Item block = null;
	public PlatinoHoeItem(ProvaModElements instance) {
		super(instance, 92);
	}
