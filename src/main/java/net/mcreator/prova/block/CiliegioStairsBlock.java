...
public class CiliegioStairsBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_stairs")
	public static final Block block = null;
	public CiliegioStairsBlock(ProvaModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ciliegio_stairs");
		}
