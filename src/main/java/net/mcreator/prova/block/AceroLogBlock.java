...
public class AceroLogBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_log")
	public static final Block block = null;
	public AceroLogBlock(ProvaModElements instance) {
		super(instance, 43);
	}
