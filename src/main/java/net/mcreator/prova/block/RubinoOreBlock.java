...
import net.mcreator.prova.item.RubinoItem;
...
public class RubinoOreBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:rubino_ore")
	public static final Block block = null;
	public RubinoOreBlock(ProvaModElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubinoItem.block, (int) (2)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("rubino_ore", "rubino_ore", blockAt -> {
