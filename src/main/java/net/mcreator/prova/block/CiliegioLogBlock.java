...
public class CiliegioLogBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_log")
	public static final Block block = null;
	public CiliegioLogBlock(ProvaModElements instance) {
		super(instance, 67);
	}
