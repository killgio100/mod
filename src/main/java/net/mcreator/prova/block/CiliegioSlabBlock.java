...
public class CiliegioSlabBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_slab")
	public static final Block block = null;
	public CiliegioSlabBlock(ProvaModElements instance) {
		super(instance, 71);
	}
