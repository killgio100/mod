...
public class AceroLeavesBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_leaves")
	public static final Block block = null;
	public AceroLeavesBlock(ProvaModElements instance) {
		super(instance, 45);
	}
