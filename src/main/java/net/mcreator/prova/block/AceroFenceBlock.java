...
public class AceroFenceBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_fence")
	public static final Block block = null;
	public AceroFenceBlock(ProvaModElements instance) {
		super(instance, 48);
	}
