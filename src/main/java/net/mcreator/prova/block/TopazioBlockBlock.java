...
public class TopazioBlockBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:topazio_block")
	public static final Block block = null;
	public TopazioBlockBlock(ProvaModElements instance) {
		super(instance, 22);
	}
