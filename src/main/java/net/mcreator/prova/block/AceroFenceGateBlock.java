...
public class AceroFenceGateBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_fence_gate")
	public static final Block block = null;
	public AceroFenceGateBlock(ProvaModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("acero_fence_gate");
		}
