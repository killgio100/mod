...
public class CiliegioFenceGateBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_fence_gate")
	public static final Block block = null;
	public CiliegioFenceGateBlock(ProvaModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("ciliegio_fence_gate");
		}
