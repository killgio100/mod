...
public class CiliegioWoodBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_wood")
	public static final Block block = null;
	public CiliegioWoodBlock(ProvaModElements instance) {
		super(instance, 66);
	}
