...
public class CiliegioPlanksBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_planks")
	public static final Block block = null;
	public CiliegioPlanksBlock(ProvaModElements instance) {
		super(instance, 68);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ciliegio_planks");
		}
