...
public class AceroWoodBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_wood")
	public static final Block block = null;
	public AceroWoodBlock(ProvaModElements instance) {
		super(instance, 42);
	}
