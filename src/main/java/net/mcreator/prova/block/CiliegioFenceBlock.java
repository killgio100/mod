...
public class CiliegioFenceBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:ciliegio_fence")
	public static final Block block = null;
	public CiliegioFenceBlock(ProvaModElements instance) {
		super(instance, 72);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ciliegio_fence");
		}
