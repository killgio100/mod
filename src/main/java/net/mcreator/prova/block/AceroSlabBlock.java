...
public class AceroSlabBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:acero_slab")
	public static final Block block = null;
	public AceroSlabBlock(ProvaModElements instance) {
		super(instance, 47);
	}
