...
public class PlatinoBlockBlock extends ProvaModElements.ModElement {
	@ObjectHolder("prova:platino_block")
	public static final Block block = null;
	public PlatinoBlockBlock(ProvaModElements instance) {
		super(instance, 84);
	}
